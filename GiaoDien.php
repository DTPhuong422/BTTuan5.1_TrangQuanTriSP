  ...
  <body>
     <div class="card-columns">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="" method="post">
                    ...
                    <button type="submit" name="btnHienThi" value="btnHienThi" class="btn btn-primary" btn-lg btn-block">Hiện Thị</button>
        ...
        <div class="card">
            <img class="card-img-top" src="holder.js/100x180/" alt="">
            <div class="card-body">
                <h4 class="card-title">Hiện thị sản phẩm </h4>
                <table class="table">
                    <thead>
                        <tr>
                            <th>MaSP</th>
     ...
     <?php
        ...
        if(isset($_POST['btnUpdate']))
        {
            ...
            $DonGia=$_POST['txtDonGia'];
            $NCC=$_POST['txtNCC'];
            $i=upDateSanPhamDB ( $MaSP, $TenSP, $DVT, $DonGia, $NCC);
            if($i<0){
